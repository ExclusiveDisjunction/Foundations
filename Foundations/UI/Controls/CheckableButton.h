...
namespace Core::UI::Controls
{
	...
	public:
		...
		CheckableButton(int X, int Y, int Width, int Height, Control* Parent, HINSTANCE ins, HMENU ID, bool IsChecked, String Text, CheckableButtonType Type, StyleSheet Style, TextStyleSheet TextStyle) : CheckableButton(X, Y, Width, Height, *Parent, ins, ID, IsChecked, Text, Type, Style, TextStyle) {}
