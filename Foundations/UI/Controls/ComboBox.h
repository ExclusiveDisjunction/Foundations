...
namespace Core::UI::Controls
{
	...
	public:
		...
		ComboBox(int X, int Y, int Width, int Height, Control* Parent, HMENU ID, HINSTANCE ins, StringList Items, StyleSheet Style, TextStyleSheet TextStyle) : ComboBox(X, Y, Width, Height, *Parent, ID, ins, Items, Style, TextStyle) {}
