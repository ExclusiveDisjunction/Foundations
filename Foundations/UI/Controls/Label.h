...
namespace Core::UI::Controls
{
	...
	public:
		...
		Label(int X, int Y, int Width, int Height, Control* Parent, HINSTANCE ins, String Text, AaColor BaseBk, TextStyleSheet Style, bool ShowScroll) : Label(X, Y, Width, Height, *Parent, ins, Text, BaseBk, Style, ShowScroll) {}
		~Label();
